 ...
 * INTEREST in flexible task help. This is lead-interest framing only — it does
 * NOT embed the consumer <FunnelForm> and it has no intake form, no backend, no
 * tRPC, no analytics. The two CTAs are plain anchors that scroll to the
 * #register placeholder, where the real intake form arrives in a later step (E2/E3).
 *
    ...
    <div className="flex flex-1 flex-col">
      ...
      <main className="relative flex-1">
        <section className="relative mx-auto flex w-full max-w-3xl flex-col gap-8 px-6 pb-16 pt-8 sm:pt-12 md:pt-16">
          ...
          <div className="space-y-4 text-center sm:text-left">
            ...
            <h1 className="text-4xl font-semibold tracking-tight text-text-primary sm:text-5xl md:text-6xl">
              Flexible local help for your business
            </h1>
        ...
        <section
          ...
          className="mx-auto w-full max-w-5xl px-6 pb-4"
        >
          <h2
            id="business-types"
        ...
        <section
          ...
          className="mx-auto w-full max-w-5xl px-6 pb-4 pt-12"
        >
          <h2
            id="use-cases"
            className="text-sm font-semibold uppercase tracking-[0.18em] text-text-muted"
        ...
        >
          <div className="rounded-2xl border border-white/10 bg-elevated/60 px-6 py-8 sm:px-8">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-brand-purple-glow">
              Early access
            </p>
            <h2
