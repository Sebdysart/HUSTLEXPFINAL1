...
import { Platform, StyleSheet, Text, TouchableOpacity, View, Vibration } from 'react-native';
...
export function LocationSetupScreen() {
  ...
  const handleFinish = async () => {
    ...
    try {
      // Web preview: the backend blocks browser requests without CORS headers.
      // Allow UI exploration by completing onboarding locally on web.
      if (Platform.OS === 'web') {
